...
export default function HydroPower() {
  ...
  return (
    <div className='bg-grid h-full w-full overflow-auto'>
      <div className='flex flex-col md:hidden w-screen h-screen bg-blue-500 bg-grid'>
        ...
        <div className='w-full h-full flex overflow-auto mb-4'>
          {currentSlide === 1 && (
            <div className={slideClassName}>
              <div className='flex p-8 relative overflow-auto w-full h-full bg-blue-500'>
                <div className='mx-auto flex flex-col w-full'>
                  <p className='text-4xl text-center font-extrabold'>
                    <span className='text-gray-100'>What is Hydro Power?</span>
                  </p>
          ...
          {currentSlide === 2 && (
            <div className={slideClassName}>
              <div className='flex p-8 relative w-full overflow-auto h-full bg-blue-500 rounded-r-2xl'>
                <div className='mx-auto flex flex-col w-full'>
                  <p className='text-4xl text-center font-extrabold'>
                  ...
                  <div className='my-auto pt-4 pl-6 pr-12'>
                    <div className='lg:text-xl md:text-md sm:text-sm font-semibold text-white'>
                      <ul className='list-disc space-y-2'>
                        <li>
                          They are essential backups during major power outages
                          and disruptions as they can generate power to the grid
                          immediately
                        </li>
                        <li>
          ...
          {currentSlide === 3 && (
            <div className={slideClassName}>
              <div className='flex p-8 relative w-full h-full overflow-auto bg-blue-500 rounded-r-2xl'>
                <div className='mx-auto flex flex-col w-full'>
                  <p className='text-4xl text-center font-extrabold'>
                    <span className='text-gray-100'>
          ...
          {currentSlide === 4 && (
            <div className={slideClassName}>
              <div className='flex p-8 relative overflow-auto w-full h-full bg-blue-500 rounded-r-2xl'>
                <div className='mx-auto flex flex-col w-full'>
                  <p className='text-4xl text-center font-extrabold'>
                      ...
                      <ul className='list-disc space-y-2'>
                        ...
                        <div className='ml-6'>
                          <li>
                            ...
                            met for zero- or negative-emitting technologies and
                            energy storage technologies. Phases out when power
                            sector emissions reach 25% of 2022 levels.
                          </li>
                        </div>
                      </ul>
                    </div>
